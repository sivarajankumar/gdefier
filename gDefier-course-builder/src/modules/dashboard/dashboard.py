...
from modules.gDefier.gDefier import GDefierDashboardHandler
from modules.gDefier.gDefier import GDefierSettingsHandler
from modules.gDefier.gDefier import GDefierSettingsRESTHandler
...
class DashboardHandler(
    ...
    GDefierDashboardHandler, GDefierSettingsHandler):
    ...
    post_actions = [
        ...
        'delete_reviewer','edit_gDefier_course_settings']
    nav_mappings = [
        ('', 'Outline'),
        ('assets', 'Assets'),
        ('settings', 'Settings'),
    ...
    def get_child_routes(cls):
        ...
        return [
            ...
            (GDefierSettingsRESTHandler.URI, GDefierSettingsRESTHandler)          
        ]
